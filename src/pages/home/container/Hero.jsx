  ...
  return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
        <div className='mt-10 lg:w-1/2'>
            ...
            <p className='text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas a, fugiat praesentium ratione illum necessitatibus optio est impedit dignissimos, architecto placeat rem omnis totam sunt, tempore</p>
